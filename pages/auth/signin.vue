            ...
            <div class="form-content">
              <form>
                <div class="form-group">
                  ...
                  <input id="username" v-model="existentUser.email" type="text" name="username" required="required"/>
                </div>
                <div class="form-group">
                  <label for="password">Contraseña</label>
                  <input id="password" v-model="existentUser.password" type="password" name="password" required="required"/>
                </div>
                <div class="form-group">
              ...
              <form>
                ...
                <div class="form-group">
                  <v-container>
                    ...
                    <v-row>
                      <v-select v-model="newUser.role" style="min-height: 48px; height:48px" :items="roles" name="email" solo filled flat background-color="rgba(0, 0, 0, 0.1)" hide-details height="48"/>
                    </v-row>
                  </v-container>
                </div>
                <div class="form-group">
...
export default {
  ...
  data() {
    return {
      ...
      roles: ['Almacenero', 'Catador', 'Tostador', 'Empaquetador'],
...
.v-select__selections input {
  background-color: #1BB887 !important;
}
.sign {
  display: flex;
